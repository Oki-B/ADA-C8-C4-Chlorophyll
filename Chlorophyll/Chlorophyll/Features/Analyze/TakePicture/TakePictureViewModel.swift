...
class TakePictureViewModel: NSObject {
    ...
    override init() {
        let (previewStream, previewContinuation) = AsyncStream.makeStream(
            of: CIImage.self
        )
    ...
    private func configureCaptureSession(
        ...
        let readinessCoordinator = AVCapturePhotoOutputReadinessCoordinator(
        ...
        photoOutput.maxPhotoDimensions = deviceInput.device.activeFormat
        ...
        photoOutput.isConstantColorEnabled =
    ...
    private func createImageFromPixelBuffer(pixelBuffer: CVPixelBuffer)
        -> UIImage?
    {
        var cgImage: CGImage?
    ...
    func takePhoto() {
        ...
        photoOutputReadinessCoordinator.startTrackingCaptureRequest(
            using: photoSettings
        )
        ...
        sessionQueue.async {
            ...
            self.photoOutputReadinessCoordinator.stopTrackingCaptureRequest(
                using: photoSettings.uniqueID
            )
        }
    }
...
extension TakePictureViewModel: AVCapturePhotoOutputReadinessCoordinatorDelegate
{
    func readinessCoordinator(
        _ coordinator: AVCapturePhotoOutputReadinessCoordinator,
        captureReadinessDidChange captureReadiness: AVCapturePhotoOutput
            .CaptureReadiness
    ) {
...
extension TakePictureViewModel: AVCapturePhotoCaptureDelegate {
    func photoOutput(
...
extension TakePictureViewModel: AVCaptureVideoDataOutputSampleBufferDelegate {
    func captureOutput(
